...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form class="form theme-form" action="{{route("contacts.store")}}" med method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                        ...
                        <input hidden value="{{$textword->client_id}}" name="client_id">
                        <input hidden value="{{$textword->id}}"  name="textword_id">
