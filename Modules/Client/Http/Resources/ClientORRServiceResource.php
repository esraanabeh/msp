...
class ClientORRServiceResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "ORR_services"  => $this->ClientORRServices ? $this->ClientORRServices->where("pivot.client_id",$request->clientId)->pluck('pivot')->unique()->all() : null,
